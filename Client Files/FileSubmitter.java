            ...
            if(!listOfDroppedFiles.isEmpty()){
               ...
               */
               ...
               //String  command = "javac *.java";       // This use to work, now errors
                  ...
                  tempString=tempFile.getAbsolutePath();
                  tempString=tempString.replace("\\","\\\\");
                  
                  String [] command = new String[] {"javac", "@"+tempString+""}; //Terminal command to be run to compile Java file
               ...
               JOptionPane.showMessageDialog(null,"You haven't added any files to submit.");
            }  
         }
      }
   }
